...
public class ImageRecognition {
    public static void main(String[] args) {
        ...
        CascadeClassifier faceCascade = new CascadeClassifier("C:\\Users\\pc\\Desktop\\JavaTrack\\haarcascade_frontalface_alt.xml");
        ...
        while (true) {
            ...
            if (capture.read(frame)) {
                ...
                HighGui.imshow("Video Face Detection", frame);
